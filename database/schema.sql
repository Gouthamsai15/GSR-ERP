...
create table public.schools (
  ...
  report_card_template_file_name text,
  report_card_template_base64 text,
  report_card_template_updated_at timestamp,
  expiry_date date,
...
alter table public.schools
  add constraint schools_board_id_fkey
...
comment on table public.schools is 'Multi-tenant school registry for GSR ERP SaaS.';
