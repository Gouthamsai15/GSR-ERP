...
import { createSchool, listBoards } from "../../services/saasService";
import type { BoardRecord, SchoolCreateValues } from "../../types/saas";
          ...
          <form className="mt-8 space-y-8" onSubmit={handleSubmit}>
            <section className="space-y-4">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <label className="block space-y-2 md:col-span-2">
                  <span className="text-sm font-medium text-slate-700">Upload Report Card Template (.xlsx)</span>
                  ...
                  <p className="text-xs text-slate-500">
                    This Excel template will be used for report-card generation. Current selection: {form.reportCardTemplateFileName || "No file selected"}
                  </p>
                </label>
              </div>
            </section>
          ...
          <SuperAdminPanel>
            ...
            <div className="mt-4 space-y-3 text-sm">
              ...
              <div className="flex items-center justify-between gap-4 page-detail-card">
                ...
                <span className="font-medium text-slate-900">{boards.find((board) => board.id === form.boardId)?.displayName || "-"}</span>
              </div>
              <div className="flex items-center justify-between gap-4 page-detail-card">
