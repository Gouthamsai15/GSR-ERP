...
type ApplicantDraftState = {
  applicantDraft?: Partial<StudentFormValues> & {
    applicantId?: string;
  };
};
...
export const StudentsPage = () => {
  ...
  const applicantDraft = (location.state as ApplicantDraftState | null | undefined)?.applicantDraft ?? null;
  ...
  useEffect(() => {
    ...
    setForm({
      ...emptyForm,
      ...applicantDraft,
      studentName: applicantDraft.studentName ?? emptyForm.studentName,
      className: applicantDraft.className ?? emptyForm.className,
      section: applicantDraft.section ?? "",
      fatherName: applicantDraft.fatherName ?? "",
      fatherEmail: applicantDraft.fatherEmail ?? "",
      fatherMobileNumber: applicantDraft.fatherMobileNumber ?? "",
    });
    setFormError("");
    setModal({ open: true, mode: "create", student: null });
    navigate(location.pathname, { replace: true, state: null });
  }, [applicantDraft, location.pathname, navigate]);
          ...
          <div className="rounded-3xl border border-slate-200 bg-slate-50 p-5">
            ...
            <div className="mt-4 grid gap-5 md:grid-cols-2">
              ...
              <Input
                ...
                required
                className="border-slate-200 bg-white text-slate-900"
                placeholder={modal.mode === "edit" ? "Student ID cannot be changed" : "Example: STU-0001"}
              />
              <label className="block">
