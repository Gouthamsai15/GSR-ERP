...
export type SchoolRecord = {
  ...
  reportCardTemplateFileName: string | null;
  reportCardTemplateUpdatedAt: string | null;
  createdAt: string | null;
...
export type SchoolUpdateValues = {
  ...
  expiryDate: string;
  reportCardTemplateFileName?: string;
  reportCardTemplateBase64?: string;
};
...
export type ReportCardGenerationType = "individual" | "class-wise";

export type ReportCardGenerationValues = {
  reportType: ReportCardGenerationType;
  examId: string;
  className: string;
  section: string;
  studentId?: string;
