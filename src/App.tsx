...
import StaffAttendancePage, { MyAttendancePage } from "./pages/dashboard/StaffAttendance";
...
import SuperAdminBoardsPage from "./pages/superAdmin/SuperAdminBoards";
import ReportCardsPage from "./pages/dashboard/ReportCards";
import {
        ...
        <Route element={<ProtectedRoute />}>
          ...
          <Route element={<RoleProtectedRoute allowedRoles={[ROLES.SUPER_ADMIN]} />}>
            <Route path="/super-admin" element={<DashboardLayout />}>
              ...
              <Route path="boards" element={<SuperAdminBoardsPage />} />
          ...
          <Route path="/dashboard" element={<DashboardLayout />}>
            ...
            <Route
              path="home"
              element={<RoleProtectedRoute allowedRoles={[ROLES.ADMIN, ROLES.PRINCIPAL]} />}
            >
            ...
            <Route element={<RoleProtectedRoute allowedRoles={[ROLES.ADMIN, ROLES.PRINCIPAL, ROLES.STAFF, ROLES.STUDENT, ROLES.PARENT]} allowedStaffWorkspaces={[STAFF_WORKSPACES.TEACHER]} />}>
