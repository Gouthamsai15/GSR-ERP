...
const baseButtonClassName =
  "inline-flex h-10 w-10 items-center justify-center rounded-full border text-sm font-semibold transition focus:outline-none focus:ring-2 focus:ring-offset-1 sm:h-8 sm:w-8";
...
const AttendanceStatusToggle = ({
  ...
  <div className="inline-flex items-center gap-1.5 rounded-full bg-slate-100 p-1.5 sm:gap-2 sm:p-1">
    <button
      type="button"
      disabled={disabled}
