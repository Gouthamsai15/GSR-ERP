...
const getItemsForRole = (role: string | null): MobileNavItem[] => {
  ...
  if (role === ROLES.STAFF) {
    return [
      { label: "Analytics", path: "/dashboard/analytics", icon: homeIcon },
  ...
  if (role === ROLES.PARENT) {
    return [
      { label: "Attendance", path: "/dashboard/attendance", icon: homeIcon },
      { label: "Timetable", path: "/dashboard/timetable", icon: calendarIcon },
      { label: "Alerts", path: "/dashboard/notifications", icon: bellIcon },
      { label: "Profile", path: "/dashboard/profile", icon: userIcon },
    ];
  ...
  return [
    { label: "Results", path: "/dashboard/results", icon: homeIcon },
    { label: "Attendance", path: "/dashboard/attendance", icon: chartIcon },
    { label: "Timetable", path: "/dashboard/timetable", icon: calendarIcon },
    { label: "Alerts", path: "/dashboard/notifications", icon: bellIcon },
    { label: "Profile", path: "/dashboard/profile", icon: userIcon },
...
export const MobileBottomNav = () => {
  ...
  const getStaffItems = (): MobileNavItem[] => {
    if (staffWorkspace === STAFF_WORKSPACES.HR) {
      return [
        { label: "HR", path: "/dashboard/hr", icon: homeIcon },
        { label: "Employees", path: "/dashboard/employees", icon: userIcon },
        { label: "Attendance", path: "/dashboard/staff-attendance", icon: chartIcon },
        { label: "Leaves", path: "/dashboard/leaves", icon: bellIcon },
        { label: "Profile", path: "/dashboard/profile", icon: shieldIcon },
      ];
    }

    if (staffWorkspace === STAFF_WORKSPACES.ACCOUNTS) {
      return [
        { label: "Accounts", path: "/dashboard/accounts", icon: homeIcon },
        { label: "Fees", path: "/dashboard/fees", icon: bellIcon },
        { label: "Salary", path: "/dashboard/salary", icon: chartIcon },
        { label: "Alerts", path: "/dashboard/notifications", icon: bellIcon },
        { label: "Profile", path: "/dashboard/profile", icon: userIcon },
      ];
    }
    ...
    if (staffWorkspace === STAFF_WORKSPACES.TRANSPORT) {
      return [
        { label: "Transport", path: "/dashboard/transport", icon: homeIcon },
        { label: "Vehicles", path: "/dashboard/vehicles", icon: chartIcon },
        { label: "Routes", path: "/dashboard/routes", icon: calendarIcon },
        { label: "Alerts", path: "/dashboard/notifications", icon: bellIcon },
        { label: "Profile", path: "/dashboard/profile", icon: userIcon },
      ];
    }
    ...
    if (staffWorkspace === STAFF_WORKSPACES.ADMISSION) {
      return [
        { label: "Admission", path: "/dashboard/admission", icon: homeIcon },
        { label: "Applicants", path: "/dashboard/applicants", icon: bellIcon },
        { label: "Students", path: "/dashboard/students", icon: userIcon },
        { label: "Alerts", path: "/dashboard/notifications", icon: bellIcon },
        { label: "Profile", path: "/dashboard/profile", icon: shieldIcon },
      ];
    }
    ...
    return [
      ...
      { label: "Alerts", path: "/dashboard/notifications", icon: bellIcon },
      { label: "Profile", path: "/dashboard/profile", icon: userIcon },
      { label: "Results", path: "/dashboard/results", icon: chartIcon },
    ];
  };

  const items = role === ROLES.STAFF ? getStaffItems() : getItemsForRole(role);
